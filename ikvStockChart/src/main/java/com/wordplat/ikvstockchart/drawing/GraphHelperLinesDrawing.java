...
/**
 * Created by rugovit on 1/25/2018.
 */
...
public class GraphHelperLinesDrawing implements IDrawing {

    protected Paint highlightPaint; // Highlight line brush

    protected final RectF contentRect = new RectF(); // Drawing area
    protected AbstractRender render;

    private List<IMarkerView> markerViewList = new ArrayList<>();

    public GraphHelperLinesDrawing() {

    }

    public GraphHelperLinesDrawing(IMarkerView... markerViews) {
